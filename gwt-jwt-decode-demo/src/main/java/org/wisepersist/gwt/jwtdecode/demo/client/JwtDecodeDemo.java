...
import org.wisepersist.gwt.ace.client.AceDefaultCommandLine;
import org.wisepersist.gwt.ace.client.AceEditorMode;
import org.wisepersist.gwt.ace.client.AceSelection;
...
public class JwtDecodeDemo implements EntryPoint {
      ...
      callback.invokeWithCompletions(new AceCompletion[]{
          ...
          new AceCompletionSnippet(
              ...
              new AceCompletionSnippetSegment[]{
                  ...
                  new AceCompletionSnippetSegmentLiteral("_\\filler_"),
                  // putting backslash in here to prove escaping is working
                  new AceCompletionSnippetSegmentTabstopItem("tabstop2"),
                  new AceCompletionSnippetSegmentLiteral("_$filler_"),
                  // putting dollar in here to prove escaping is working
  ...
  public void onModuleLoad() {
    ...
    editor1.addCommand(new AceCommandDescription(
        "increaseFontSize", new AceCommandDescription.ExecAction() {
      @Override
    ...
    editor1.addCommand(new AceCommandDescription(
        "decreaseFontSize", new AceCommandDescription.ExecAction() {
      @Override
      public Object exec(AceEditor editor) {
        int fontSize = editor.getFontSize();
    ...
    editor1.addCommand(new AceCommandDescription(
        "resetFontSize", new AceCommandDescription.ExecAction() {
      @Override
      public Object exec(AceEditor editor) {
    ...
    removeMarks.addClickHandler(new ClickHandler() {
      ...
      public void onClick(ClickEvent event) {
        if (editor1.getMarkers().isEmpty()) {
          // add some markers
          editor1.addMarker(AceRange.create(0, 0, 1, 41), "ace_selection", AceMarkerType.FULL_LINE,
                            false);
          editor1.addFloatingMarker(AceRange.create(2, 2, 2, 38), "ace_selected-word",
                                    AceMarkerType.TEXT);
        } else {
